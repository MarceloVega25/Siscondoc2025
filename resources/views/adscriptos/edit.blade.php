...
@section('content')
    <div class="content" style="margin-left: 20px">
        <h1>Actualizar Datos del Adscripto</h1>
        ...
        <div class="row">
            <div class="col-md-11">
                <div class="card card-outline card-success">
                    ...
                    <div class="card-body">
                        <form action="{{ url('/adscriptos', $adscripto->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            {{ method_field('PATCH') }} 
                                ...
                                <div class="col-md-9">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nombre_apellido" class="form-control" 
                                                    value="{{ ($adscripto->nombre_apellido) }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="dni" class="form-control"
                                                    value="{{($adscripto->dni) }}" required maxlength="8">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="fecha_nacimiento" class="form-control"
                                                    value="{{ ($adscripto->fecha_nacimiento) }}" required>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="genero" class="form-control" required>
                                                    ...
                                                    <option value="masculino" {{ trim(strtolower($adscripto->genero)) == 'masculino' ? 'selected' : '' }}>Masculino</option>
                                                    <option value="femenino" {{ trim(strtolower($adscripto->genero)) == 'femenino' ? 'selected' : '' }}>Femenino</option>
                                                    <option value="otro" {{ trim(strtolower($adscripto->genero)) == 'otro' ? 'selected' : '' }}>Otro</option>
                                                </select>
                                                @error('genero')
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="email" name="email" class="form-control"
                                                    value="{{ ($adscripto->email) }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="telefono" class="form-control"
                                                    value="{{ ($adscripto->telefono) }}" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="direccion" class="form-control"
                                                    value="{{ ($adscripto->direccion) }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="localidad_ciudad" class="form-control"
                                                    value="{{ ($adscripto->localidad_ciudad) }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            @if ($adscripto->cv)
                                                <p><a href="{{ asset('storage/' . $adscripto->cv) }}" target="_blank">Ver CV actual</a></p>
                                            @endif
                                        </div>
                                    </div>
                                </div>
...
<div class="col-md-3">
    <div class="form-group">
        ...
        <center>
            @php
                if (!empty($adscripto->fotografia) && file_exists(public_path('storage/' . $adscripto->fotografia))) {
                    // Usa la foto del usuario si existe en storage
                    $fotoPath = asset('storage/' . $adscripto->fotografia);
                } else {
                    // Usa el avatar correspondiente si no hay foto
                    $avatarPath = 'images/' . strtolower($adscripto->genero) . '.jpg';
            ...
            reader.readAsDataURL(file);
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <hr>
                                    <div class="form-group">
                                        <a href="{{ route('adscriptos.index') }}" class="btn btn-danger">Cancelar</a>
