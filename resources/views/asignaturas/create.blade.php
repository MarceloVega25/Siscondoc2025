...
<div class="content" style="margin-left: 20px">
    <h1>Creación de una nueva Asignatura</h1>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nombre" class="form-control"
                                        placeholder="Ingrese Nombre de Asignatura" value="{{ old('nombre') }}" required>
                                    @error('nombre')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="siglas" class="form-control"
                                        placeholder="Ingrese Siglas de Asignatura" value="{{ old('siglas') }}" required>
                                    @error('siglas')
                                        <small style="color: red;">*Este campo es requerido</small>
                                    @enderror
                                </div>
