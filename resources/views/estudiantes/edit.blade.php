                                ...
                                <div class="col-md-9">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nombre_apellido" class="form-control" 
                                                    value="{{ ($estudiante->nombre_apellido) }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="dni" class="form-control"
                                                    value="{{($estudiante->dni) }}" required maxlength="8">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="genero" class="form-control" required>
                                                    ...
                                                    <option value="masculino" {{ trim(strtolower($estudiante->genero)) == 'masculino' ? 'selected' : '' }}>Masculino</option>
                                                    <option value="femenino" {{ trim(strtolower($estudiante->genero)) == 'femenino' ? 'selected' : '' }}>Femenino</option>
                                                    <option value="otro" {{ trim(strtolower($estudiante->genero)) == 'otro' ? 'selected' : '' }}>Otro</option>
                                                </select>
                                                @error('genero')
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="institucion" class="form-control"
                                                    value="{{ ($estudiante->institucion) }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="tipo" class="form-control" required>
                                                    <option value="">Seleccione...</option>
                                                    <option value="titular" {{ trim(strtolower($estudiante->tipo)) == 'titular' ? 'selected' : '' }}>Titular</option>
                                                    <option value="suplente" {{ trim(strtolower($estudiante->tipo)) == 'suplente' ? 'selected' : '' }}>Suplente</option>
                                                </select>
                                                @error('tipo')
                                                    <small style="color: red;">*Este campo es requerido</small>
                                                @enderror
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            @if ($estudiante->cv)
                                                <p><a href="{{ asset('storage/' . $estudiante->cv) }}" target="_blank">Ver CV actual</a></p>
                                            @endif
                                        </div>
                                    </div>
                                </div>
...
<div class="col-md-3">
    <div class="form-group">
        ...
        <center>
            @php
                if (!empty($estudiante->fotografia) && file_exists(public_path('storage/' . $estudiante->fotografia))) {
                    // Usa la foto del usuario si existe en storage
                    $fotoPath = asset('storage/' . $estudiante->fotografia);
                } else {
                    // Usa el avatar correspondiente si no hay foto
                    $avatarPath = 'images/' . strtolower($estudiante->genero) . '.jpg';
