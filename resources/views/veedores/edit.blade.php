...
@section('content')
    <div class="content" style="margin-left: 20px">
        <h1>Actualizar Datos del Veedor</h1>
        ...
        <div class="row">
            <div class="col-md-11">
                <div class="card card-outline card-success">
                    ...
                    <div class="card-body">
                        <form action="{{ url('/veedores', $veedor->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            {{ method_field('PATCH') }} 
                                ...
                                <div class="col-md-9">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nombre_apellido" class="form-control" 
                                                    value="{{ ($veedor->nombre_apellido) }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="dni" class="form-control"
                                                    value="{{($veedor->dni) }}" required maxlength="8">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="fecha_nacimiento" class="form-control"
                                                    value="{{ ($veedor->fecha_nacimiento) }}" required>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="genero" class="form-control" required>
                                                    ...
                                                    <option value="masculino" {{ trim(strtolower($veedor->genero)) == 'masculino' ? 'selected' : '' }}>Masculino</option>
                                                    <option value="femenino" {{ trim(strtolower($veedor->genero)) == 'femenino' ? 'selected' : '' }}>Femenino</option>
                                                    <option value="otro" {{ trim(strtolower($veedor->genero)) == 'otro' ? 'selected' : '' }}>Otro</option>
                                                </select>
                                                @error('genero')
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="telefono" class="form-control"
                                                    value="{{ ($veedor->telefono) }}" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="institucion" class="form-control"
                                                    value="{{ ($veedor->institucion) }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            @if ($veedor->cv)
                                                <p><a href="{{ asset('storage/' . $veedor->cv) }}" target="_blank">Ver CV actual</a></p>
                                            @endif
                                        </div>
                                    </div>
                                </div>
...
<div class="col-md-3">
    <div class="form-group">
        ...
        <center>
            @php
                if (!empty($veedor->fotografia) && file_exists(public_path('storage/' . $veedor->fotografia))) {
                    // Usa la foto del usuario si existe en storage
                    $fotoPath = asset('storage/' . $veedor->fotografia);
                } else {
                    // Usa el avatar correspondiente si no hay foto
                    $avatarPath = 'images/' . strtolower($veedor->genero) . '.jpg';
