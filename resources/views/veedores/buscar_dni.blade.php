        ...
        <div class="col-md-11">
            <div class="card card-outline card-warning">
                ...
                <div class="card-body" style="display: block;">
                    <form method="POST" action="{{ route('veedores.buscarDni') }}">
                        @csrf
...
@if(session('mensaje') === 'existe')
    <script>
        Swal.fire({
            ...
            window.location.href = "{{ route('veedores.edit', session('veedor_id')) }}";
        });
    </script>
@endif
...
@if(session('mensaje') === 'nuevo')
    <script>
        Swal.fire({
            ...
            window.location.href = "{{ route('veedores.create', ['dni' => session('dni')]) }}";
        });
    </script>
@endif
<script>
