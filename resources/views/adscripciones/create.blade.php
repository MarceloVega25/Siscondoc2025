...
@section('content')
    <div class="content" style="margin-left: 20px">
        <h1>Creación de una nueva Adscripción</h1>
        ...
        <div class="row">
            <div class="col-md-11">
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-body">
                        <form action="{{ route('adscripciones.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-4">
                                    <label for="tipo_adscripcion">Tipo de Adscripción</label><b>*</b>
                            ...
                            <div class="form-group mt-3">
                                ...
                                <button type="submit" class="btn btn-primary">Guardar Adscripción</button>
                            </div>
                        </form>
                    </div>
                </div>
