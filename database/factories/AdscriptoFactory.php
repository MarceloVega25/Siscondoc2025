...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\Adscripto>
 */
class AdscriptoFactory extends Factory
{
    protected $model = Adscripto::class;
    ...
    public function definition(): array
    {
        return [
            ...
            'localidad_ciudad' => $this->faker->city(), // Genera una ciudad aleatoria
